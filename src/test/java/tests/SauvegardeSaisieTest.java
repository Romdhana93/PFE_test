...
public class SauvegardeSaisieTest {
	...
	public void setUp() throws Exception {
		...
		test1 = extent.createTest("Sauvegarde saisie santé");
		test2 = extent.createTest("Sauvegarde saisie prévoyance");
	...
	public void testUntitledTestCase() throws Exception {
		...
		SauvegardeSaisiePage svs = new SauvegardeSaisiePage(driver);
		...
		driver.findElement(svs.nomSaisie).sendKeys("Test Sauvegarde Saisie");
