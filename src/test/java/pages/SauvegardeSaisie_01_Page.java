...
public class SauvegardeSaisie_01_Page {
	...
	public By ajout3Entrprise = By.xpath(
			"/html/body/app-root/app-home/div/app-body/app-saisie/p-tabview/div/div/p-tabpanel/div/p-tabview/div/div[2]/p-tabpanel[1]/div/app-reference-society/div/app-api-siren/div/div/div/div[3]/p-treetable/div/div/table/tbody/tr[7]/td[9]") ;
	...
	public By complStatut = By.xpath(
			"/html/body/app-root/app-home/div/app-body/app-saisie/p-tabview/div/div/p-tabpanel/div/p-tabview/div/div[2]/p-tabpanel[3]/div/app-projet-description/app-offre-description/div/form/div/div/div[16]/div/p-checkbox/div/div[2]");
	...
	public SauvegardeSaisie_01_Page(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void ongletSocietDeRefference() {
		...
		driver.findElement(ajout3Entrprise).click();
